...
const WhyJoinPage = () => {
    return (
        <div className="Section  w-full h-[816px] iphone:w-full iphone:h-full iphone:px-4 iphone:pt-4 iphone:pb-14 px-20 py-40 flex-col justify-center items-center inline-flex">
