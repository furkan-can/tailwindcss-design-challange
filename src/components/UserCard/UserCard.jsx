    ...
    return (
        ...
        <div className="UserCard self-stretch pt-4 justify-start items-center gap-4 inline-flex">
            ...
            <div className="Details grow shrink basis-0 flex-col justify-start items-start inline-flex">
                <div className="Category self-stretch text-black text-lg font-normal leading-[28.80px]">{name}</div>
                <div className="Category self-stretch text-slate-600 text-base font-normal leading-snug">{role}</div>
            </div>
        </div>
    );
}
